...
class Atomic_edge_only(torch.nn.Module):
    def __init__(self, args):
        super(Atomic_edge_only, self).__init__()
    ...
    def forward(self, nodes, pos, attmat_gt):
        ...
        # node out [N,5,12,4]
        # edge_out=edge_out.view(N,-1)  # [N, 80]
        ...
        # # [N ,159]
        # en_out=edge_out #todo: check the dim here [N,40]
