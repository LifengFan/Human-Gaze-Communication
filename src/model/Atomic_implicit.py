...
class Atomic_node_only_implicit(torch.nn.Module):
    def __init__(self, args):
        super(Atomic_node_only_implicit, self).__init__()
    ...
    def forward(self, nodes, pos, attmat_gt):
        ...
        attmat=self.link_fun(edge_feat.view(N*sq_len, 24,4,4)).squeeze(1).view(N,sq_len,4,4) # attmat [N, 1, max_node_num, max_node_num]
